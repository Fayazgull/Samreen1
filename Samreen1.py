...
\033[1;32m║GITHUB         : Samreen1-git\x1b[1;91m    
...
class Main:
	...
	def fbtua(self):
		...
		try:
			...
			os.system('xdg-open https://github.com/Fayazgull/Samreen1.git')
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s\033[92;1m[Samreen] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
